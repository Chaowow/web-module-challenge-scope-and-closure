...
// counter1 has 2 functions with one function referencing from an external variable. Counter1 is the one with a closure because there's a function inside of a function. Counter1 would be preferable when you want the inner function to remember what you logged last so it can keep counting up, while counter2 would be preferable when you just want to log something once and get the same thing no matter how many times you log.
